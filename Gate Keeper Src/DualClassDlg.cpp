// DualClassDlg.cpp : implementation file
//
...
CDualClassDlg::CDualClassDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CDualClassDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDualClassDlg)
	m_nLevel = 0;
	m_nProfAxe = 0;
	m_nProfBlunt = 0;
	m_nProfBow = 0;
...
void CDualClassDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDualClassDlg)
	DDX_Text(pDX, IDC_FIRST_LEVEL, m_nLevel);
	DDV_MinMaxUInt(pDX, m_nLevel, 1, 50);
...
BEGIN_MESSAGE_MAP(CDualClassDlg, CDialog)
	//{{AFX_MSG_MAP(CDualClassDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDualClassDlg message handlers

BOOL CDualClassDlg::OnInitDialog() 
{
